...
---
---@class dreamwork.std.encoding.base64
...
---
---@class dreamwork.std.encoding.base64.Alphabet
...
do
    ...
    ---@return dreamwork.std.encoding.base64.Alphabet alphabet The alphabet.
...
---
---@class dreamwork.std.encoding.base64.Variant
---@field alphabet dreamwork.std.encoding.base64.Alphabet The 64-character alphabet used for encoding and decoding.
...
---@type table<string, dreamwork.std.encoding.base64.Variant>
local variants = {
    standard = {
        alphabet = standard,
        pad = "="
...
---
---@class dreamwork.std.encoding.base64.Options : dreamwork.std.encoding.base64.Variant
---@field variant "standard" | "urlsafe" | "mime" | "jwt" | "custom" The base64 variant to use.
---@field alphabet dreamwork.std.encoding.base64.Alphabet | nil The 64-character alphabet used for encoding and decoding.

---@param options dreamwork.std.encoding.base64.Options
...
---@param options? dreamwork.std.encoding.base64.Options The base64 encoding options.
