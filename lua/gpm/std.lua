...
do
    ...
    local ErrorClass = std.class.create( Error )
    ...
    function ErrorClass.make(name, base)
        local base = std.class.base(name, base or std.Error)
        return std.class.create(base) ---@type Error
    end
...
do
    ...
    gpm.logger = std.Logger( gpm_PREFIX, {
