...
---@field protected __serialize? fun( obj: gpm.std.Object, writer: gpm.std.crypto.pack.Writer ) A function that will be called when the object is serialized.
---@field protected __deserialize? fun( obj: gpm.std.Object, reader: gpm.std.crypto.pack.Reader ) A function that will be called when the object is deserialized.
