...
do
    ...
    ---@field private queue gpm.std.Queue Queue of values.
    ---@field private getters gpm.std.Queue Queue of getters.
    ---@field private setters gpm.std.Queue Queue of setters.
