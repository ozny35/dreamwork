...
---@operator add( gpm.std.Vector2 | number ): gpm.std.Vector2
---@operator sub( gpm.std.Vector2 | number ): gpm.std.Vector2
...
---@operator add( gpm.std.Vector3 | number ): gpm.std.Vector3
---@operator sub( gpm.std.Vector3 | number ): gpm.std.Vector3
...
---@operator add( gpm.std.Angle3 | number ): gpm.std.Angle3
---@operator sub( gpm.std.Angle3 | number ): gpm.std.Angle3
...
do
    ...
    ---
    ---@param self gpm.std.Vector2 The vector.
    ...
    --- Scales the vector.
    ---
    ---@param self gpm.std.Vector2 The vector to scale.
    ...
    do
        ...
        ---
        ---@param self gpm.std.Vector2 The vector to add to.
        ...
        ---@protected
        ---@param value gpm.std.Vector2 | number
        ---@return gpm.std.Vector2
    ...
    do
        ...
        ---
        ---@param self gpm.std.Vector2 The vector to subtract from.
    ...
    do
        ...
        ---
        ---@param self gpm.std.Vector2 The vector to multiply.
        ---@param vector gpm.std.Vector2 The other vector or a number.
        ---@return gpm.std.Vector2 multiplied_vector The product of the two vectors or the vector multiplied by a number.
    ...
    do
        ...
        ---
        ---@param self gpm.std.Vector2 The vector to divide.
    ...
    do
        ...
        ---
        ---@param self gpm.std.Vector2 The vector to calculate the length of.
        ...
        ---
        ---@param self gpm.std.Vector2 The vector to normalize.
    ...
    ---
    ---@param self gpm.std.Vector2 The vector to calculate the angle of.
    ...
    ---@return gpm.std.Vector2 vec3 The interpolated vector.
...
do
    ...
    --- Creates a copy of the vector.
    ---
    ---@param self gpm.std.Vector3 The vector.
    ...
    do
        ...
        ---
        ---@param self gpm.std.Vector3 The vector to rotate.
...
do
    ...
    ---
    ---@param self gpm.std.Angle3 The angle.
    ...
    do
        ...
        ---@protected
        ---@param angle gpm.std.Angle3
        ---@return gpm.std.Angle3
